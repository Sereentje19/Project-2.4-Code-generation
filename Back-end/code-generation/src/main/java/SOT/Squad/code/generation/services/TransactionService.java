...
public class TransactionService {
    ...
    public List<TransactionResponseDTO> findBankAccountResponse(String iban, List<AccountType> accountType, Date startDate, Date endDate, String operator, int amount) {
