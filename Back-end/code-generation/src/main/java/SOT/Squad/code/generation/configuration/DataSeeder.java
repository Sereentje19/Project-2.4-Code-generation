...
//      bankAccountService.addBankAccount(bankacc1);
        ...
        //Users
//        userService.addUser(new User(4, "SOTBank", "SOTBank", "SOTBank", "SOTBank", 061234567, "SOTBank@gmail.com", "BankStreet", 1, "1234AB", "Haarlem", List.of(bankacc1.getId()), List.of(Role.EMPLOYEE), "0000"));
        userService.addUser(new User(1, "thijs", "moerland", "Thijs", "Moerland", 064567, "Moerland8", "123street", 53, "2131GB", "hoofddorp", List.of(bankacc2.getId()), List.of(Role.CUSTOMER), "4321"));
        userService.addUser(new User(2, "om", "al", "Omar", "Al Sayasna", 064567, "Moerland8", "123street", 53, "2131GB", "hoofddorp",  List.of(bankacc2.getId()), List.of(Role.CUSTOMER), "4321"));
        userService.addUser(new User(3, "serena", "kenter", "Serena", "Kenter", 064567, "Moerland8", "123street", 53, "2131GB", "hoofddorp", List.of(bankacc2.getId(), bankacc3.getId()), List.of(Role.CUSTOMER), "4321"));
