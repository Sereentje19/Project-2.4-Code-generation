...
public class DataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        transactionService.AddTransaction(new Transaction(1, "test", 100, "deposit","deposit", "NL12INHO0123456789", "NL12INHO0123456787","kenmerk"));
        transactionService.AddTransaction(new Transaction(2, "test", 100, "withDraw","deposit", "NL12INHO0123456788", "NL12INHO0123456789","kenmerk"));
        transactionService.AddTransaction(new Transaction(3, "test", 100, "deposit","deposit", "NL12INHO0123456787", "NL12INHO0123456788","kenmerk"));
