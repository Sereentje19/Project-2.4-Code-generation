...
public class DataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        bankAccountService.addBankAccount(new BankAccount(0, "NL12INHO0123456789", "CURRENT", "Euro", 1000, 1, false));
        bankAccountService.addBankAccount(new BankAccount(0, "NL12INHO0123456788", "SAVING", "Euro", 2000, 1,false));
        bankAccountService.addBankAccount(new BankAccount(0, "NL12INHO0123456787", "CURRENT", "Euro", 100, 2,false));
